...
fn generate_bodies(
    ...
    for _ in 0..NUM_BODIES {
        ...
        let mass_value = FloatPow::cubed(radius) * 10.0;
        ...
        .spawn((
            BodyBundle {
                ...
                material: MeshMaterial3d(materials.add(StandardMaterial {
                    ...
                    emissive: LinearRgba::from(ORANGE_RED) * 2.0,
                    ..default()
                })),
                mass: Mass(500.0),
                ..default()
...
fn interact_bodies(mut query: Query<(&Mass, &GlobalTransform, &mut Acceleration)>) {
    ...
    ) = iter.fetch_next()
    {
        ...
        let forch_unit_mass = delta * f;
        acc1.0 += forch_unit_mass * *m2;
        acc2.0 -= forch_unit_mass * *m1;
    }
}
